...
const Navbar = () => {
  ...
  return (
    <div className='absolute top-0 left-0 w-full z-10'>
        <div className='container mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-32 bg-transparent mt-3'>
            ...
            <button className='hidden md:block bg-white px-8 py-2 rounded-full hover:bg-gray-400 cursor-pointer'>Sign Up</button>
